...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-charcoal text-charcoal dark:text-white pt-24 pb-12">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">Dedicated to raising the standards of sanitation and construction across South Sudan with integrity and innovation.</p>
            <div className="flex gap-4">
              <a className="size-10 rounded-full bg-slate-100 dark:bg-white/10 flex items-center justify-center hover:bg-primary hover:text-white transition-colors" href="#">
        ...
        <div className="pt-12 border-t border-slate-200 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
